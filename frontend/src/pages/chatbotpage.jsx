...
import { MessageCircle, Send, Bot, User, ArrowLeft, Sparkles, Stethoscope, Brain, Heart, Zap } from "lucide-react";
...
export default function ChatbotPage() {
        ...
        try {
            ...
            simulateTyping(data.answer, (currentText) => {
                setMessages(prev => prev.map((msg, idx) => 
                    idx === prev.length - 1 
                        ? { ...msg, text: currentText, isTyping: currentText.length < data.answer.length }
                        : msg
                ));
            });
    ...
    const formatMessage = (text) => {
        // Simple formatting for medical responses
        return text.split('\n').map((line, index) => {
        ...
        <div className="min-h-screen bg-black text-white overflow-hidden relative">
            ...
            <div className="relative z-10 container mx-auto px-6 py-12 h-screen flex flex-col">
                ...
                <div className="text-center mb-8">
                    ...
                    <h1 className="text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-teal-100 to-white mb-4 mt-10">
                        AI MEDICAL
                    ...
                    <p className="text-lg text-gray-300 max-w-2xl mx-auto leading-relaxed">
                        ...
                        <span className="text-teal-400 font-semibold"> Ask questions, get expert insights 24/7.</span>
                    </p>
                </div>

                {/* Chat Container */}
                <div className="flex-1 max-w-4xl mx-auto w-full flex flex-col">
                    <div className="bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl border border-white/20 shadow-2xl flex flex-col h-full">
                        ...
                        >
                            {messages.length === 0 && (
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-xl font-bold text-white mb-2">Welcome to AI Medical Assistant</h3>
                                    <p className="text-gray-400 mb-6">Ask any medical question and get expert guidance instantly</p>
                            ...
                            {messages.map((msg, idx) => (
                                <div key={idx} className={`flex ${msg.sender === "user" ? "justify-end" : "justify-start"}`}>
                                    <div className={`flex items-start max-w-xs md:max-w-md lg:max-w-lg xl:max-w-xl ${msg.sender === "user" ? "flex-row-reverse" : "flex-row"}`}>
                                        <div className={`w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 ${msg.sender === "user" ? "ml-3 bg-gradient-to-r from-blue-500 to-purple-500" : "mr-3 bg-gradient-to-r from-teal-500 to-cyan-500"}`}>
                                        ...
                                        <div className={`px-4 py-3 rounded-2xl ${
                                            ...
                                            <div className={`text-xs mt-2 opacity-70 ${msg.sender === "user" ? "text-blue-200" : "text-gray-400"}`}>
                                                {msg.timestamp}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start">
                                        ...
                                        <div className="px-4 py-3 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl">
                                            <div className="flex items-center space-x-2">
                                                ...
                                                <span className="text-gray-300 text-sm">Dr. AI is thinking...</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="flex items-center space-x-4">
                                <div className="flex-1 relative">
                                    <input
                                        ...
                                        onKeyPress={(e) => e.key === 'Enter' && !loading && question.trim() && handleSend(e)}
                                        disabled={loading}
                                    />
